        ...
        <div id="store_container">
           <div class="promo_main_header sub_title">
                ...
                <div class="store_details_anchors pull-right">
                    <a href="/map">
                        <tt>Map</tt>
                        <img src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1520025071000/locationicon.png" class="map_icon" alt="">
                    </a>
                    <a id="promo_anchor" href="#promos_main" v-if="promotions.length > 0">
                        <tt>Promos (<span>{{currentStore.total_published_promos}}</span>)</tt>
                        <img src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1520025071000/tagicon.png" class="promo_icon" alt="">
                    </a>
                    <a id="job_anchor" href="#jobs_main" v-if="jobs.length > 0">
                        <tt>Jobs (<span>{{currentStore.total_published_jobs}}</span>)</tt>
                        <img src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1520025071000/careericon.png" class="job_icon" alt="jobs icon">
                    </a>
                </div>
            </div>
            <div class="row" style="width:100%;">
                <div class="col-md-8 col-sm-8  col-xs-12">
                    <div id="map">
                        ...
                        <mapplic-map ref="mapplic_ref" :height="300" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="[currentStore]" :floorlist="floorList" tooltiplabel="Info" action="none" :showPin="true" @updateMap="updateMap" :key="currentStore.id"></mapplic-map>
                    </div>
                ...
                currentStore : function (){
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if(current_promo.store !== null && current_promo.store !== undefined && _.includes(current_promo.store.image_url, 'missing')) {
                            current_promo.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/jpeg/1515531874445/canyon_crest_default.jpg";
                        }
                    ...
                    if(_.includes(this.currentStore.image_url, 'missing'))
                        this.currentStore.image_url = "//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/jpeg/1515531874445/canyon_crest_default.jpg";
