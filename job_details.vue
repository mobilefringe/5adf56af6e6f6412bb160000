    ...
    <div class="row main_container" v-if="currentJob">
        ...
        <div class="row mobile_padding" id="promo_details_container">
            <div class="col-md-4 col-sm-4">
                ...
                <img class="details_image" v-else src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1513356843893/canyon_crest_logo.png" :alt="property.name" />
            </div>
                        ...
                        <div class="blog-social-share">
                            ...
                            <div class="social_share">
                                <network network="facebook">
                                    <img src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1512057980767/fb@2x_whiteborder.png" class="" alt="">
                                </network>
                                <network network="twitter">
                                    <img src="//codecloud.cdn.speedyrails.net/sites/5adf56af6e6f6412bb160000/image/png/1512058120246/twt@2x_whiteborder.png" class="" alt="">
                                </network>
                            </div>
                        </div>
                    </social-sharing>
    ...
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment"], function(Vue, Vuex, moment, tz, VueMoment) {
        return Vue.component("job-details-component", {
            ...
            methods: {
                ...
                shareURL(slug) {
                    var share_url = "http://wwwcaramel.codecloudapp.com/jobs/" + slug;
                    return share_url;
                }
            }
        });
