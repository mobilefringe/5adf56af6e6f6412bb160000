        ...
        <div class="content_container  position_relative hidden_phone" style="padding:0">
            <div class="main_container">
                <div class="newsletter_container text-center">
                        ...
                        <p class="newsletter_desc sub_title">{{$t('home_page.read_more')}} <br class="show_phone" /><span>•</span> {{$t('home_page.read_more')}}<br class="show_phone" /><span>•</span> {{$t('home_page.read_more')}}</p>
